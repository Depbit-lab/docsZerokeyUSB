...
| `0x0068–0x00E3` | 124 B | TOTP metadata: 2 B × 62 slots (algorithm + secret_len) | `CONFIG_TOTP_META_START` |
| `0x0100–0x1FFF` | 7 936 B | 62 credential slots (128 B each = 4 pages × 32 B) | `EEPROM_CREDENTIAL_BASE` |
